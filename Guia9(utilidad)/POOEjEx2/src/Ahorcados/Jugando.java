...
public class Jugando {
    ...
    public static void main(String[] args) {
        ...
        // puedo llamar al metodo AhorcadoS.juego() y crear un objeto dentro de ese metodo 
        // o puedo crear un objeto aca en la main y pasarlo como parametro al metodo(juego) 
        //AhorcadoS.juego(); 
        Ahorcado juego = new Ahorcado();
        AhorcadoS.juego(juego);
        // Crear el objeto en la main me permite crear varios objetos para trabajarlos de diferentes maneras.
        //Ahorcado juego2 = new Ahorcado();
        //AhorcadoS.juego(juego2);
    }
